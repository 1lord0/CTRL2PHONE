...
const en: Strings = {
  ...
  'status.copiedToClipboard': 'Image copied to clipboard — Ctrl+V to paste',
  'status.uploadingPhone': 'Image copied to clipboard, sending to phone...',
  'status.sentPhone': 'Image copied to clipboard and sent to phone',
  ...
  'label.closePanel': 'Minimize panel (Esc)',
  'label.quitApp': 'Quit application',
  'label.pillVisibility': 'Floating button',
  'opt.pillAlways': 'Always visible',
  'opt.pillBackground': 'Background (hotkey)',
  'opt.pillCaptureOnly': 'Only during screen capture',
  'hint.pillVisibility':
    'Background mode hides the pill; use Ctrl+Shift+Space to open the panel. Hotkeys still work.',
  'tray.openPanel': 'Open panel',
  'tray.showPill': 'Show floating button',
  'tray.hidePill': 'Move to background',
  'tray.quit': 'Quit',
};
...
const tr: Strings = {
  ...
  'hero.lede':
    "İki kere üst üste sol Ctrl'e basınca seçim katmanı açılır. Fareyle alanı çizdikten sonra: X veya Enter ile yapay zeka sağlayıcına, M ile Telefona gönderirsiniz. İptal etmek için Esc tuşuna basın. Q ile çık.\nCtrl+Shift+V → Panodaki metni/linki anında telefona gönderir.",
  'label.prompt': 'Yapay zeka için kısa not',
  ...
  'label.aiSettingsHeader': 'Yapay Zeka ve Dil Ayarları',
  ...
  'label.aiProvider': 'Yapay zeka sağlayıcı',
  ...
  'btn.setupRls': 'Güvenli Kurulum: RLS SQL kopyala ve Supabase aç',
  'btn.quit': 'Uygulamadan Çık',
  'hint.setupRls':
  ...
  'status.copiedToClipboard': 'Görsel panoya kopyalandı — Ctrl+V ile yapıştır',
  'status.uploadingPhone': 'Görsel panoya kopyalandı, telefona gönderiliyor...',
  'status.sentPhone': 'Görsel panoya kopyalandı ve telefona gönderildi',
  ...
  'label.closePanel': 'Paneli küçült (Esc)',
  'label.quitApp': 'Uygulamadan çık',
  'label.pillVisibility': 'Yüzen buton',
  'opt.pillAlways': 'Her zaman görünür',
  'opt.pillBackground': 'Arka planda (kısayol)',
  'opt.pillCaptureOnly': 'Sadece ekran seçiminde',
  'hint.pillVisibility':
    'Arka plan modunda pill gizlenir; panel için Ctrl+Shift+Space kullanın. Kısayollar çalışmaya devam eder.',
  'tray.openPanel': 'Paneli aç',
  'tray.showPill': 'Yüzen butonu göster',
  'tray.hidePill': 'Arka plana al',
  'tray.quit': 'Çıkış',
};
