...
const en: Strings = {
  ...
  'opt.langTr': 'Türkçe',
  'panel.tagline':
    'Double Ctrl → capture (HUD stays visible) · Ctrl+Shift+Space → panel · Esc → close',
  'label.pinPanel': 'Pin panel open',
  'label.unpinPanel': 'Unpin panel',
  'label.openPanel': 'Open panel (Ctrl+Shift+Space)',
  'label.closePanel': 'Close panel (Esc)',
};
