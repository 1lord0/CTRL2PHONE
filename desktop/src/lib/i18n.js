...
const en = {
    ...
    'opt.langEn': 'English',
    'opt.langTr': 'Türkçe',
    'panel.tagline': 'Double Ctrl → capture (HUD stays visible) · Ctrl+Shift+Space → panel · Esc → close',
...
const tr = {
    ...
    'opt.langEn': 'English',
    'opt.langTr': 'Türkçe',
    'panel.tagline': 'Çift Ctrl → yakala (HUD görünür kalır) · Ctrl+Shift+Space → panel · Esc → kapat',
